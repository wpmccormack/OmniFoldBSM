...
data = np.concatenate([sig_sim[int(sys.argv[1])+6][:nsig],bkg_sim[nevs:nevs+nbkg]])
sim = np.concatenate([sig_sim[0][-begin:], sig_sim[1][-begin:], sig_sim[2][-begin:], sig_sim[3][-begin:], sig_sim[4][-begin:], sig_sim[5][-begin:], sig_sim[6][-begin:], sig_sim[7][-begin:], sig_sim[8][-begin:], sig_sim[9][-begin:], sig_sim[10][-begin:], sig_sim[11][-begin:], bkg_sim[:nevs]])
gen = np.concatenate([sig_gen[0][-begin:], sig_gen[1][-begin:], sig_gen[2][-begin:], sig_gen[3][-begin:], sig_gen[4][-begin:], sig_gen[5][-begin:], sig_gen[6][-begin:], sig_gen[7][-begin:], sig_gen[8][-begin:], sig_gen[9][-begin:], sig_gen[10][-begin:], sig_gen[11][-begin:], bkg_gen[:nevs]])

dataT = np.concatenate([sig_gen[int(sys.argv[1])+6][:nsig],bkg_gen[nevs:nevs+nbkg]])
simT = np.concatenate([sig_gen[0][-begin:], sig_gen[1][-begin:], sig_gen[2][-begin:], sig_gen[3][-begin:], sig_gen[4][-begin:], sig_gen[5][-begin:], sig_gen[6][-begin:], sig_gen[7][-begin:], sig_gen[8][-begin:], sig_gen[9][-begin:], sig_gen[10][-begin:], sig_gen[11][-begin:], bkg_gen[:nevs]])


Mdata = np.concatenate([invmc[int(sys.argv[1])+6][:nsig],invma[nevs:nevs+nbkg]])
Msim = np.concatenate([invmc[0][-begin:], invmc[1][-begin:], invmc[2][-begin:], invmc[3][-begin:], invmc[4][-begin:], invmc[5][-begin:], invmc[6][-begin:], invmc[7][-begin:], invmc[8][-begin:], invmc[9][-begin:], invmc[10][-begin:], invmc[11][-begin:], invma[:nevs]])
Mgen = np.concatenate([invmcT[0][-begin:], invmcT[1][-begin:], invmcT[2][-begin:], invmcT[3][-begin:], invmcT[4][-begin:], invmcT[5][-begin:], invmcT[6][-begin:], invmcT[7][-begin:], invmcT[8][-begin:], invmcT[9][-begin:], invmcT[10][-begin:], invmcT[11][-begin:], invmaT[:nevs]])

MdataT = np.concatenate([invmcT[int(sys.argv[1])+6][:nsig],invmaT[nevs:nevs+nbkg]])
MsimT = np.concatenate([invmcT[0][-begin:], invmcT[1][-begin:], invmcT[2][-begin:], invmcT[3][-begin:], invmcT[4][-begin:], invmcT[5][-begin:], invmcT[6][-begin:], invmcT[7][-begin:], invmcT[8][-begin:], invmcT[9][-begin:], invmcT[10][-begin:], invmcT[11][-begin:], invmaT[:nevs]])
...
np.savez('/data0/users/wmccorma/'+str(percname)+'PercSig_'+str(sys.argv[1])+'MeV_Omni_synthsig_not125_corrData.npz', **{'X_det_part': tmpX_det, 'Y_det': Y_det, 'X_gen_part': tmpX_gen, 'Y_gen': Y_gen, 'X_detT_part': tmpX_detT, 'Y_detT': Y_detT, 'X_det_glob': MtmpX_det, 'X_gen_glob': MtmpX_gen, 'X_detT_glob': MtmpX_detT})
