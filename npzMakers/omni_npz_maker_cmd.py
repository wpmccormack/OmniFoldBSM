...
bkg_sim = a['sim_particles'][:500000]
bkg_gen = a['gen_particles'][:500000]
...
np.savez('/data0/users/wmccorma/'+str(percname)+'PercSig_1mil_'+str(sys.argv[1])+'MeV.npz', **{'X_det': X_det, 'Y_det': Y_det, 'X_gen': X_gen, 'Y_gen': Y_gen})
