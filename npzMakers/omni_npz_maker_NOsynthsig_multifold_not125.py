...
np.savez('/data0/users/wmccorma/'+str(percname)+'PercSig_'+str(sys.argv[1])+'MeV_NOsynthsig_multifold_not125.npz', **{'Y_det': Y_det, 'Y_gen': Y_gen, 'Y_detT': Y_detT, 'X_det_glob': MtmpX_det, 'X_gen_glob': MtmpX_gen, 'X_detT_glob': MtmpX_detT})
