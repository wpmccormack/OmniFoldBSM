...
np.savez('/data0/users/wmccorma/Herwig_Data_synthsig_21.npz', **{'X_det_part': tmpX_det, 'Y_det': Y_det, 'X_gen_part': tmpX_gen, 'Y_gen': Y_gen, 'X_detT_part': tmpX_detT, 'Y_detT': Y_detT, 'X_det_glob': MtmpX_det, 'X_gen_glob': MtmpX_gen, 'X_detT_glob': MtmpX_detT})
