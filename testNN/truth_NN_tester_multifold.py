...
json_file = open('/data0/wmccorma/16000_SB_45_Feb_3_multifold.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("/data0/wmccorma/16000_SB_45_Feb_3_multifold_labels.h5")
...
fi2 = np.load('/data0/wmccorma/10PercSig_5MeV_synthsig_multifold.npz', allow_pickle=True)

X_det2 = fi2['X_detT_glob'][:200000]
X_det3 = fi2['X_gen_glob'][:260000]
...
np.savez('16000MeV_10Perc_SB_45_Feb_3_preds_DATA_multifold.npz', **{'preds_half_true': preds, 'fpr_half_true': fpr, 'tpr_half_true': tpr, 'th_half_true': th, 'sif_half_true': sif, 'preds_data': preds2, 'fpr_data': fpr, 'tpr_data': tpr, 'th_data': th, 'sif_data': sif, 'preds_gen': preds3})
