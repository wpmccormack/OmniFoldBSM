...
fi2 = np.load('/data0/wmccorma/0PercSig_5MeV_Pythia_omnifold_NOsynthsig.npz', allow_pickle=True)

X_det2 = fi2['X_detT_part'][:200000]
X_det3 = fi2['X_gen_part'][:200000]

#Y_det2 = ef.utils.to_categorical(np.concatenate((np.ones(20000), np.zeros(198000))))
...
#np.savez('16000MeV_10Perc_SB_150_Apr_27_preds_DATA.npz', **{'preds_half_true': preds, 'fpr_half_true': fpr, 'tpr_half_true': tpr, 'th_half_true': th, 'sif_half_true': sif, 'preds_data': preds2, 'fpr_data': fpr, 'tpr_data': tpr, 'th_data': th, 'sif_data': sif, 'preds_gen': preds3})

np.savez('16000MeV_0Perc_SB_150_Apr_27_preds_DATA.npz', **{'preds_data': preds2, 'preds_gen': preds3})
