...
fi2 = np.load('/data0/wmccorma/0PercSig_5MeV_synthsig.npz', allow_pickle=True)
...
np.savez('16000MeV_0Perc_SB_150_Apr_27_preds_synthsig_DATA.npz', **{'preds_data': preds2, 'preds_gen': preds3})
