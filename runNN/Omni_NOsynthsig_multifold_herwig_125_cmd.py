...
fi = np.load('/data0/wmccorma/'+percval+'Sig_'+massval+'MeV_NOsynthsig_multifold_herwig.npz', allow_pickle=True)
...
multifold_ws = of.omnifold(X_gen, Y_gen, X_det, Y_det, wdata, winit, (ef.archs.dnn.DNN, det_args), (ef.archs.dnn.DNN, mc_args), fitargs, val=0.2, it=itnum, trw_ind=-2, weights_filename='/data0/wmccorma/Official_NOsynthsig_multifold_'+percval+'_perc_'+massval+'_mass_herwig125')
